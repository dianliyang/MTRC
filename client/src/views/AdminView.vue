          ...
          <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8">
            ...
            >
              <div class="relative overflow-hidden rounded-xl shadow-lg border-4 border-transparent transition-all duration-500"
                ...
                <img :src="proxyImage(book.coverUrl)" class="w-20 h-28 object-cover" />
            ...
            <div class="flex items-center gap-6">
              <div class="flex -space-x-4 overflow-hidden py-1">
                <template v-if="meeting.Books && meeting.Books.length > 0">
                  <img v-for="book in meeting.Books.slice(0, 3)" :key="book.id" :src="proxyImage(book.coverUrl)" class="w-12 h-16 object-cover rounded-lg ring-4 ring-white shadow-sm" />
                </template>
