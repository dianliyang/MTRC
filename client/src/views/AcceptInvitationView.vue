<template>
  <div class="max-w-md mx-auto mt-20 animate-fade-in px-4">
    ...
    <div v-else-if="status === 'success'" class="text-center space-y-8">
    ...
    <div v-else-if="status === 'expired'" class="text-center space-y-8">
    ...
    <div v-else class="space-y-12">
      ...
      <div class="bg-white/40 backdrop-blur-md p-8 rounded-[2rem] border border-white shadow-sm space-y-8">
        <div class="space-y-2">
