...
CREATE TABLE `__new_books` (
	...
	`created_at` integer DEFAULT '"2026-01-21T00:33:49.913Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-01-21T00:33:49.913Z"' NOT NULL
);
...
--> statement-breakpoint
INSERT INTO `__new_users`("id", "email", "password", "name", "role", "invitation_token", "created_at", "updated_at", "deleted_at") SELECT "id", "email", "password", "name", "role", NULL, "created_at", "updated_at", "deleted_at" FROM `users`;--> statement-breakpoint
DROP TABLE `users`;--> statement-breakpoint
ALTER TABLE `__new_users` RENAME TO `users`;--> statement-breakpoint
CREATE UNIQUE INDEX `users_email_unique` ON `users` (`email`);--> statement-breakpoint
CREATE UNIQUE INDEX `users_invitation_token_unique` ON `users` (`invitation_token`);