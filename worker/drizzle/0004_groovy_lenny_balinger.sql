...
CREATE TABLE `__new_books` (
	...
	`created_at` integer DEFAULT '"2026-01-20T22:45:43.876Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-01-20T22:45:43.876Z"' NOT NULL
);
...
CREATE TABLE `__new_comments` (
	...
	`text` text,
	`book_id` integer,
	`created_at` integer DEFAULT '"2026-01-20T22:45:43.877Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-01-20T22:45:43.877Z"' NOT NULL,
