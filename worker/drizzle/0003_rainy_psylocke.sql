CREATE TABLE `likes` (
	...
	`user_id` integer,
	`book_id` integer,
	`created_at` integer DEFAULT '"2026-01-20T22:28:45.353Z"' NOT NULL,
...
CREATE TABLE `__new_books` (
	...
	`created_at` integer DEFAULT '"2026-01-20T22:28:45.353Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-01-20T22:28:45.353Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2026-01-20T22:28:45.352Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-01-20T22:28:45.352Z"' NOT NULL,
	`deleted_at` integer
);
--> statement-breakpoint
