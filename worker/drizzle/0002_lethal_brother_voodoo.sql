...
CREATE TABLE `__new_books` (
	...
	`suggester_id` text,
	`created_at` integer DEFAULT '"2026-01-20T22:23:15.974Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-01-20T22:23:15.974Z"' NOT NULL
);
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2026-01-20T22:23:15.973Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-01-20T22:23:15.973Z"' NOT NULL,
	`deleted_at` integer
);
--> statement-breakpoint
